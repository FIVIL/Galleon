...
namespace Galleon.IO
{
    public static class File
    {
        ...
        {
            string path = ((string.IsNullOrEmpty(filePath) == true) ? (filePath + "\\") : "") + fileName + "." + extension.ToString();
        ...
        {
            return ((string.IsNullOrEmpty(filePath) == true) ? (filePath + "\\") : "") + fileName + "." + extension.ToString();
        }
